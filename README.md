...
---
## Use Reggy with your companion AI that doesn’t work together

Connect your agent to Reggy for cross-session memory. Choose a native integration for automatic recall and session capture, or use MCP to give your agent memory and context tools. Reggy with other AI companion to ensure similar trading knowledge and risk management.
